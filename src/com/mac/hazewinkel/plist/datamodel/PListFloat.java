 ...
 */
public class PListFloat extends PListPrimitive {
    private double value;

    public PListFloat(double value) {
        this.value = value;
    }
    ...
    public void setAsString(String newValue) throws IllegalArgumentException {
        ...
        try {
            ...
            throw new IllegalArgumentException("Cannot parse as real number: " + e.getMessage());
        }
    }

    @Override
    public PListDataType getType() {
        return PListDataType.Real;
    }
}
